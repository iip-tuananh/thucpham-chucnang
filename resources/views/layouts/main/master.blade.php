 ...
 <script src="{{asset('frontend/js/notify.min.js')}}"></script>
    ...
    <script type="text/javascript">
        ...
        window.addEventListener("load", function() {
            ...
            arcItem.href =
                "https://mail.google.com/mail/u/0/#inbox?compose=GTvVlcSDbgsbbfHSWBLDhmwrmsxLrRNLXNzmlxXhzwrKhgDNXDtmflmljgsClxMgHNRvcXLhCbGrT";
            arcItem.color = "#f4b033";
            arcItems.push(arcItem);
            var arcItem = {};
            arcItem.id = "msg-item-8";
            arcItem.class = "msg-item-phone";
            arcItem.title = "Call 0335 996661";
            arcItem.icon =
