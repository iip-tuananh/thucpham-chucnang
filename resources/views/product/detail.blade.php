             ...
             <div class="col-xs-12 col-md-6">
              <div class="nav-bredcrum">
                ...
                <div class="k2-info-single details-product">
                   ...
                   <div class="price_sp">
                      <span class="woocommerce-Price-amount amount"><bdi>{{number_format($product->price,0,'','.')}}&nbsp;<span class="woocommerce-Price-currencySymbol">VNĐ</span></bdi></span>
     ...
     <div class="khungsp1 w-100">
      ...
      <div class="item_sp1">
         <div class="img_sp" style="height: 272px">
            ...
            <img width="759" height="653" src="{{$img_prolq[0]}}" class="attachment-full size-full wp-post-image" decoding="async" loading="lazy" srcset="{{$img_prolq[0]}} 759w, {{$img_prolq[0]}} 600w, {{$img_prolq[0]}} 300w" sizes="(max-width: 759px) 100vw, 759px">                                            </a>
         </div>
         <div class="mota_sp">
            <h4><a href="{{route('detailProduct',['slug'=>$item->slug])}}">{{languageName($item->name)}}</a></h4>
