...
Route::group(['namespace'=>'Client','middleware' => ['checkLanguage']], function(){
    ...
    Route::get('bao-gia/{slug}.html','PageController@projectDetail')->name('projectDetail');
    ...
    Route::get('cau-chuyen-thuong-hieu.html','PageController@cauchuyen')->name('cauchuyen');
